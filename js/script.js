...
function getRandom() {
  ...
  if (recipeData[random].totalTime > 45) {
    ...
    <div class="d-flex align-items-center gap-3 bg-red-100 p-3 rounded-3 error-section">
      ...
      <div>
        <p class="mb-0 text-red-800 fw-medium">
          Extended Preparation Time
        </p>
        <p class="mb-0 text-red-600 fs-6 lead">
    ...
    `;
    document.getElementById("totalTime").innerHTML = container;
  } else {
  ...
  function getInstructions() {
    ...
    document.getElementById("instructions").innerHTML = content;
  }
  getInstructions();
  ...
  function getTips() {
    ...
    document.getElementById("tips").innerHTML = content;
  }
  getTips();
  ...
  function getNutrition() {
    ...
    document.getElementById("nutrition").innerHTML = content;
  }
  getNutrition();
}
getRandom();
